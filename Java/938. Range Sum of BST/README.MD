<h1 class="title__20p2"><a href="https://leetcode-cn.com/problems/range-sum-of-bst/">938. Range Sum of BST</a></h1>

<div class="notranslate"><p>Given the <code>root</code> node of a binary search tree, return the sum of values of all nodes with value between <code>L</code> and <code>R</code> (inclusive).</p>

<h1 class="title__20p2"><a href="https://leetcode-cn.com/problems/implement-stack-using-queues/">225. Implement Stack using Queues</a></h1>

<div class="notranslate"><p>Implement the following operations of a stack using queues.</p>

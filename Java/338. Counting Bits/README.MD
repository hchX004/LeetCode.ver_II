<h1 class="title__20p2"><a href="https://leetcode-cn.com/problems/counting-bits/">338. Counting Bits</a></h1>

<div class="notranslate"><p>Given a non negative integer number <b>num</b>. For every numbers <b>i</b> in the range <b>0 ≤ i ≤ num</b> calculate the number of 1's in their binary representation and return them as an array.</p>

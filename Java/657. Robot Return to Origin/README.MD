<h1 class="title__20p2"><a href="https://leetcode-cn.com/problems/robot-return-to-origin/">657. Robot Return to Origin</a></h1>

<div class="notranslate"><p>There is a robot starting at position (0, 0), the origin, on a 2D plane. Given a sequence of its moves, judge if this robot <strong>ends up at (0, 0)</strong> after it completes its moves.</p>
